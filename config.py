...
def _default_cache_dir() -> str:
    """Pick a writable cache directory for the current runtime."""
    if os.getenv('VERCEL') == '1' or os.getenv('VERCEL_ENV'):
        return os.path.join(tempfile.gettempdir(), 'dijinst-cache')
...
class Config:
    ...
    # Cache configuration
    CACHE_DIR = os.getenv('DIJINST_CACHE_DIR', _default_cache_dir())
